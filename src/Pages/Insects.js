  ...
  render() {
    return (
      ...
      <div className="contact-card">
          ...
          <h3><font color="#3AC1EF"> Шипоноска чёрная </font></h3>
          <p>Биология изучена недостаточно. Известно, что самка откладывает 
            яйца по одному под эпидермис в мягкие ткани листа основного 
            кормового растения.Численность крайне низкая, 
            ее тенденции неясны. Найдено всего несколько экземпляров.</p>
      </div>
      <div className="contact-card">
          <img align="center" src={Dibka}/>
          <h3><font color="#3AC1EF"> Дыбка степная </font></h3>
          <p>Дыбка—самый крупный кузнечик в области, причем, почти полностью бескрылый.
            Уникален вид и по способу размножения: его популяции почти по всему ареалу 
            представлены только самками, размножающимися партеногенетически.</p>
      </div>
